...
DISCORD_USER_ID="1482202051256651816"  # Default: Your Discord user ID
CALLBACK_GROUP=""              # Agent's own group for callback
CALLBACK_DM=""                 # Discord user ID for DM callback
CALLBACK_ACCOUNT="pineapple"   # Discord bot account for DM callback
CALLBACK_SESSION="${OPENCLAW_SESSION_KEY:-}"
WORKDIR="/home/admin/clawd"
AGENT_TEAMS=""
AGENT_ID=""
AGENTS_JSON=""
TEAMMATE_MODE=""
...
while [[ $# -gt 0 ]]; do
    case "$1" in
        ...
        -g|--group) DISCORD_USER_ID="$2"; shift 2;;  # Discord user ID for notification
